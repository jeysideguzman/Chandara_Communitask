...
//        tabLayout.addTab(tabLayout.newTab().setIcon(R.drawable.ic_heart));
        ...
        drawableResList.add(R.drawable.newhomenav);
        drawableResList.add(R.drawable.searchicon);
        drawableResList.add(R.drawable.addpostblack);
        drawableResList.add(R.drawable.notiffill);
...
//                        tabLayout.getTabAt(0).setIcon(R.drawable.ic_home_fill);
                        tab.setIcon(R.drawable.newhomenav);
                        break;
                    ...
                    case 2:
                        tab.setIcon(R.drawable.addpostblack);
                        break;

                    case 3:
                        tab.setIcon(R.drawable.notiffill);
                        break;
