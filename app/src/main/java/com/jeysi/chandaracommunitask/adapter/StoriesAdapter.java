...
import static com.jeysi.chandaracommunitask.ViewStoryActivity.FILE_TYPE;
import static com.jeysi.chandaracommunitask.ViewStoryActivity.VIDEO_URL_KEY;
...
import com.jeysi.chandaracommunitask.ViewStoryActivity;
...
import com.jeysi.chandaracommunitask.StoryAddActivity;
import com.jeysi.chandaracommunitask.model.StoriesModel;
...
public class StoriesAdapter extends RecyclerView.Adapter<StoriesAdapter.StoriesHolder> {
    ...
    public void onBindViewHolder(@NonNull StoriesAdapter.StoriesHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if (position == 0) {
            ...
            Glide.with(activity)
                    .load(activity.getResources().getDrawable(R.drawable.addpostblack))
