...
import com.jeysi.chandaracommunitask.model.ChatModel;
...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.ChatHolder> {
    ...
    static class ChatHolder extends  RecyclerView.ViewHolder{
        ...
        public ChatHolder(@NonNull View itemView) {
            ...
            leftChat = itemView.findViewById(com.gowtham.library.R.id.x_right);
            //leftChat = itemView.findViewById(R.id.leftChat);
            rightChat = itemView.findViewById(com.gowtham.library.R.id.x_right);
